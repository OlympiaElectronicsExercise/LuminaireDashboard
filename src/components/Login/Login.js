                    ...
                    <div className="p-10 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 " action="#">
                            <div>
                                <label
                                    for="email"
                                    class="block mb-2 text-sm font-medium text-white mt-10"
                                >
                                    Email
                                </label>
                                <input
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-start mt-7">
                                    <div class="flex items-center h-5">
                                        <input
                                            ...
                                            type="checkbox"
                                            class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-3"
                                            required=""
                                        />
                                    </div>
                                ...
                                <a
                                    ...
                                    class="text-sm font-medium text-primary-600 hover:underline text-white mt-7"
                                >
                                    Forgot password?
                                </a>
                            </div>
